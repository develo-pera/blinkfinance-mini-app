...
const EditProfilePage = ({ userData, setLoadingState, refetchUser, setActivePage }: { userData?: IUser, setLoadingState: (loadingState: boolean) => void, refetchUser: () => void, setActivePage: (page: ActivePage) => void }) => {
